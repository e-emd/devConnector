    ...
    <Fragment>
      ...
      <form className='form' onSubmit={onSubmit}>
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Pleasse use a comma separated values (eg. HTML, JS, CSS, PHP)
          </small>
        </div>
        ...
        <div className='form-group'>
          <textarea
            ...
            onChange={onChange}
          />
          <small className='form-text'>Tell use a little about yourself</small>
        </div>
...
ProfileForm.propTypes = {
  createProfiled: PropTypes.func.isRequired,
