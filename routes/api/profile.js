...
// @route GET api/profile/user/:uesr_id
...
// @desc DELETE a experiene from profile
// @access Private
...
router.get('/github/:username', async (req, res) => {
  try {
    ...
    const headers = {
      'user-agent': 'node.js',
      Authoriztion: `token${config.get('githubToke')}`,
    };

    const githubuResponse = await axios.get(uri, { headers });
    return res.json(githubuResponse.data);
  } catch (err) {
    console.error(err.message);
